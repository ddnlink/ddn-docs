---
id: ddn-node-sdk-api
title: DDN Node.js SDK Api
sidebar_label: DDN Node.js SDK Api
---
...
await ddnsdk.assetPlugin.createPluginAsset(60, issuer, secret, secondSecret)
{
    type: 60,
    nethash: "0ab796cd",
    amount: "0",
...
await ddnsdk.assetPlugin.createPluginAsset(61, obj, secret, secondSecret)
{
    type: 61,
    nethash: "0ab796cd",
    amount: "0",
...
await ddnsdk.assetPlugin.createPluginAsset(62, obj, secret, secondSecret)
{
    type: 62,
    nethash: "0ab796cd",
    amount: "0",
...
await ddnsdk.assetPlugin.createPluginAsset(63, obj, secret, secondSecret)
{
    type: 63,
    nethash: "0ab796cd",
    amount: "0",
...
await ddnsdk.assetPlugin.createPluginAsset(64, obj, secret, secondSecret)
{
    type: 64,
    nethash: "0ab796cd",
    amount: "0",
...
await ddnsdk.assetPlugin.createPluginAsset(65, obj, secret, secondSecret)
{
    type: 65,
    nethash: "0ab796cd",
    amount: "0",
...
```
> ddnsdk.delegate.createDelegate(userName, secret, secondSecret || undefined)
{
    type: 2,
    nethash: "0ab796cd",
    amount: "0",
...
> ddnsdk.vote.createVote(voteContent, secret, secondSecret || undefined);
{
    type: 3,
    nethash: "0ab796cd",
    amount: "0",
...
await ddnsdk.assetPlugin.createPluginAsset(11, dapp, secret, secondSecret)
{
    type: 11,
    nethash: "0ab796cd",
    amount: "0",
...
await ddnsdk.assetPlugin.createPluginAsset(12, obj, secret, secondSecret)
{
    type: 12,
    nethash: "0ab796cd",
    amount: "1000000000000",
...
var transaction = await ddnsdk.assetPlugin.createPluginAsset(12, obj, secret, secondSecret)
{
    type: 13,
    nethash: "0ab796cd",
    amount: "0",
...
await ddnsdk.assetPlugin.createPluginAsset(10, assetEvidence, secret, secondSecret)
{
    type: 10,
    nethash: "0ab796cd",
    amount: "0",
...
var transaction = await ddnsdk.transaction.createTransaction(targetAddress, amount, message, secret, secondSecret)
...
await ddnsdk.crypto.getBytes(transaction) 
...
```
// 此时transaction.signature和transaction.signSignature都会计算在内
await ddnsdk.crypto.getHash(transaction)
...
ddnsdk.crypto.verifyBytes(buf,transaction.signature,transaction.senderPublicKey)
true
```
...
```
ddnsdk.options.set('secret','avocado immense push minor borrow display rebel depart core buzz right distance')
```
...
var epochTime = ddnsdk.utils.slots.getTime(unix_timestamp * 1000)
40655896    // DDN时间戳
```
...
var real_time = ddnsdk.utils.slots.getRealTime(epochTime)
